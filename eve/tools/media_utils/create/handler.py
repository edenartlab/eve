...
async def handler(args: dict, user: str = None, agent: str = None):
    ...
    if image_tool == txt2img:
        ...
        return await txt2img.async_run(args)
    ...
    if image_tool == flux_schnell:
        ...
        return await flux_schnell.async_run(args)
        ...
        return await flux_dev_lora.async_run(args)
        ...
        return await flux_dev.async_run(args)
        ...
        return await flux_kontext.async_run(args)
        ...
        return await openai_image_generate.async_run(args)
        ...
        return await openai_image_edit.async_run(args)
