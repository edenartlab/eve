...
def should_form_memories(
    ...
    try:
        ...
        last_memory_message_id = session.memory_context.last_memory_message_id if session.memory_context else None

        # Pass last_memory_message_id to ensure we fetch enough messages
        session_messages = select_messages(session, last_memory_message_id=last_memory_message_id)
...
async def form_memories(
    ...
    try:
        ...
        # Pass last_memory_message_id to ensure we fetch enough messages
        session_messages = select_messages(session, last_memory_message_id=old_last_memory_message_id)
