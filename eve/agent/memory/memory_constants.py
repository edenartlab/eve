...
USER_MEMORY_CONSOLIDATION_PROMPT = """Task: You are going to consolidate all memories regarding one specific user's preferences and personal context for all your future interactions with this user.
